...
const appCardCss = "/*!@:host*/.sc-app-card-h{display:block;font-family:sans-serif}/*!@**/*.sc-app-card{box-sizing:border-box;padding:0;margin:0}/*!@article*/article.sc-app-card{display:grid;gap:1.2rem;padding:1.2rem;border:1px solid #eee;border-radius:0.5rem;background:#fff;box-shadow:0 0 0.5rem #eee;grid-template-rows:repeat(2, min-content);height:300px}/*!@h2*/h2.sc-app-card{font-size:1.4rem;font-weight:600;color:#333}/*!@p*/p.sc-app-card{font-size:1.2rem;color:#999;font-weight:400}";
var AppCardStyle0 = appCardCss;
...
class AppCard {
    ...
    static get style() { return AppCardStyle0; }
...
class AppRoot {
    ...
    render() {
        return (hAsync("div", { key: 'dafd17024fcd91d6f89153761ac135aa492696be' }, hAsync("app-card", { key: '6b73d92fa82787bcbf49a82a24b1248b988ad4e9', index: 1 }), hAsync("app-card", { key: '2fb8ad527dbd691d0090a047edafa2a08885fc86', index: 2 })));
    }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "app-root",
